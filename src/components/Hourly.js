...
function Hourly(props) {
    ...
    useEffect(() => {
        if (props.data.hourly !== undefined) {
            ...
            setImgUrl("http://openweathermap.org/img/wn/" + props.data.hourly[props.hour].weather[0].icon + "@2x.png");
        }
    ...
    const formatHour = () => {
        ...
        var fullDate = new Date(
            (props.data.hourly[props.hour].dt + props.data.timezoneOffset + tempDate.getTimezoneOffset() * 60) * 1000
        );
    ...
    return props.data.hourly !== undefined ? (
        <Animated animationIn="bounceIn" isVisible={true}>
            <div className="hourMainDiv">
                ...
                <img src={imgUrl} alt="icon" className="svg" />
